...
eMAXIS Slim 全世界株式(オール・カントリー)の直近基準価額と、午前10時・午後11時の予想基準価額を前日比で表示する静的Webアプリです。
...
別サーバーは使いません。GitHub Actionsが `data/snapshot.json` を日本時間の午前10時・午後11時に更新してコミットします。
